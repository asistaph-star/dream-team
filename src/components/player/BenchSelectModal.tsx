                ...
                {tabFilteredRoster.map((player) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {isNameUsed && (
                        <div className="absolute -bottom-3 left-1/2 -translate-x-1/2 z-20 px-3 py-[3px] flex items-center justify-center">
                          <div className="absolute inset-0 bg-zinc-950/95 border border-amber-500/50 shadow-[0_4px_15px_rgba(245,158,11,0.5)] skew-x-[-12deg] z-0 pointer-events-none"></div>
