...
function MatchPageContent() {
  ...
  if (viewState === 'SIMULATING' || viewState === 'HALFTIME') {
    return (
      <GameStage 
        stageRef={stageRef}
        backgroundImage="https://www.dreamteamph.com/bg/match_stadium-v2.webp"
  ...
  if (viewState === 'SEASON_MAP') {
    return (
      <GameStage className="pointer-events-auto">
        <SeasonMap 
          onStartMatch={(diff, opponentName) => startMatch(diff, opponentName)} 
          onBack={() => router.push('/')} 
        />
        <BottomNav />
      </GameStage>
