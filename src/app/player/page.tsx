                  ...
                  >
                    ...
                    {isExactLineup && (
                      <div className="absolute -top-1.5 -right-1.5 z-30 group flex flex-col items-end">
                        ...
                        {/* Custom Tooltip */}
                        <div className="absolute right-[calc(100%+8px)] top-1/2 -translate-y-1/2 w-[140px] shadow-2xl pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-200 z-50">
                          ...
                          <div className="absolute -right-[4px] top-1/2 -translate-y-1/2 w-2 h-2 bg-[#2a2b2f] border-t border-r border-white/10 rotate-45 z-0"></div>
