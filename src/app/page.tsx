...
import { GameViewport, GameStage, useGameViewportScale } from "@/components/layout/GameViewport";
import { BottomNav } from "@/components/layout/BottomNav";

export default function AuthenticLobby() {
  return (
    <GameViewport>
      <AuthenticLobbyContent />
    </GameViewport>
  );
}

function AuthenticLobbyContent() {
  const {
    tk,
    cash,
    accountLevel,
  ...
  // Resize event listener has been replaced with the GameViewport resize hook context.
  ...
  return (
    <>
      ...
      <GameStage
        stageRef={stageRef}
        backgroundImage="/bg/stadium-v9.png"
      ...
      >
        ...
        {isDraggingOOPGlobal && (
          <SkewedBadge 
            className="absolute left-1/2 -translate-x-1/2 z-[200] pointer-events-none flex items-center justify-center animate-[fadeIn_0.2s_ease-out]"
            style={{ top: `${visibleRect.top + 120}px` }}
        ...
        <div 
          ...
          style={{ left: `${visibleRect.left + 24}px`, top: `${visibleRect.top + 160}px` }}
        >
          <img alt="gameData" src="/bg/button/gamedata.webp" className="w-[35px] h-[35px] cursor-pointer hover:scale-110 transition" />
        </div>
        <div 
          className="absolute z-20"
          style={{ left: `${visibleRect.left + 74}px`, top: `${visibleRect.top + 160}px` }}
        >
        ...
        <div 
          className="absolute z-20"
          style={{ left: `${visibleRect.left + 24}px`, top: `${visibleRect.top + 210}px` }}
        >
        ...
        <div 
          ...
          style={{ left: `961px`, top: `65px`, width: `162px`, height: `324px` }}
        >
        ...
        <div 
          className="absolute z-10 pointer-events-none"
          style={{ left: `1145px`, top: `130px`, width: `173px`, height: `270px` }}
        >
